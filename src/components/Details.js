    ...
    <div className="details-cont" id="mydetails">
      <div className="details-top">
        ...
        <div className="profile-name">
          <span className="profile-name-black">Hi I am</span> Abhishek Kumar
          <span className="blinking-colon"> ;</span>
        </div>
        <div className="profile-extras">
          <span className="profile-extras-quote">
            <span className="profile-name-black">Front End</span> Web Developer
          </span>
          <a
            href="https://drive.google.com/file/d/10FsFewSC2TbJ804dJC34oQwnb_5O-qQ_/view?usp=drive_link"
            target="_new"
          >
